...
<div class="card shadow-sm">
    <div class="card-header bg-light">
        <h5>{{ trans('global.create') }} {{ trans('cruds.salesTier.title_singular') }}</h5>
    </div>

    <form method="POST" action="{{ route("admin.sales-tiers.store") }}" enctype="multipart/form-data">
        <div class="card-body">
            @csrf
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control {{ $errors->has('commission') ? 'is-invalid' : '' }}" type="number" name="commission[]" id="commission" step="0.01" required>
