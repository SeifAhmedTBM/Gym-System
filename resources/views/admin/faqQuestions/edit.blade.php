...
<div class="card">
    <div class="card-header">
        <h5>{{ trans('global.edit') }} {{ trans('cruds.faqQuestion.title_singular') }}</h5>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.faq-questions.update", [$faqQuestion->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('question') ? 'is-invalid' : '' }}" name="question" id="question" >{{ old('question', $faqQuestion->question) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('answer') ? 'is-invalid' : '' }}" name="answer" id="answer" >{{ old('answer', $faqQuestion->answer) }}</textarea>
...
@section('scripts')
    <script>
        ...
        ClassicEditor.create( document.querySelector( '#answer' ) ).then(editor => {
            editor2 = editor;
        });
    </script>
@endsection