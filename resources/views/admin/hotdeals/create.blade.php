...
<div class="card">
    <div class="card-header">
        <h5>{{ trans('global.create') }} {{ trans('cruds.hotdeal.title_singular') }}</h5>
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.hotdeals.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('redeem') ? 'is-invalid' : '' }}" type="text" name="redeem" id="redeem" value="{{ old('redeem', '') }}" required>
