    ...
    @can('action_create')
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', ['model' => 'Action', 'route' => 'admin.actions.parseCsvImport'])
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            <h5>{{ trans('cruds.action.title_singular') }} {{ trans('global.list') }}</h5>
        </div>
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-Action').DataTable(dtOverrideGlobals);
