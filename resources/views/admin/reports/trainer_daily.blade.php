                ...
                <form action="{{ URL::current() }}" method="get">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="col-lg-2">
                                <a href="{{ route('admin.reports.trainer-daily-report') }}" class="btn btn-warning">
                        ...
                        <tbody>
                            @foreach ($payment as $pay)
                                <tr>
                                    ...
                                    <td>{{ $pay->invoice->membership->trainer->name ?? '-' }}</td>
                                    <td>{{ $pay->invoice->membership->assigned_coach->name ?? '-' }}</td>
                                    <td>{{ $pay->invoice->membership->assign_date ?? '-' }}</td>
                        ...
                        <tbody>
                            @foreach ($refund as $ref)
                                <tr>
                                    ...
                                    <td>{{ $ref->invoice->membership->trainer->name ?? '-' }}</td>
                                    <td>{{ $ref->invoice->membership->assigned_coach->name ?? '-' }}</td>
                                    <td>{{ $ref->invoice->membership->assign_date ?? '-' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
