        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body bg-success text-white">
                    ...
                    <h3 class="text-center">{{ $membership->service_pricelist->freeze_count .' '.App\Models\Setting::first()->freeze_duration}}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <div class="card-body bg-info text-white">
                    ...
                    <h3 class="text-center">{{ $membership->service_pricelist->freeze_count - $diff .' '. App\Models\Setting::first()->freeze_duration}}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('freeze') ? 'is-invalid' : '' }}" type="number"
                            name="freeze" id="freeze" value="{{ old('freeze', '0') }}" step="1">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control date {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text"
                            name="start_date" id="start_date" value="{{ old('start_date') ?? date('Y-m-d') }}" required>
                    ...
                    <input type="hidden" value="{{ $membership->id }}" id="membership_id" name="membership_id">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control date {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text"
                            name="end_date" id="end_date" value="{{ old('end_date') ?? date('Y-m-d') }}" required readonly>
