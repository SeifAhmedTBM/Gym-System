...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h5>{{ trans('global.settlement_invoices') }} {{ trans('global.list') }}</h5>
        </div>

        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-settlement-Invoice">
                <thead>
                    <tr>
                        <th width="10"></th>
                        <th>#</th>
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: "{{ route('admin.invoices.settlement',request()->all()) }}",
                columns: [{
                        data: 'placeholder',
                        name: 'placeholder'
                    },
            ...
            let table = $('.datatable-settlement-Invoice').DataTable(dtOverrideGlobals);
