            ...
            <div class="table-responsive text-center">
                <table class="table table-bordered table-hover">
                    <thead class="font-weight-bold">
                        <tr>
                            <td width="100">#</td>
                            <td width="300">{{ trans('global.name') }}</td>
                                ...
                                <tr>
                                    <td colspan="3" class="text-center bg-secondary text-white">
                                        <div class="custom-control custom-checkbox d-inline mx-3">
                                            <input type="checkbox" name="permissions[]"  value="{{ $permission['True'] }}"  class="custom-control-input" id="{{ $permission['True'] }}"  >
                                        ...
                                        @foreach ($permission as $per_name => $per)
                                            ...
                                            <div class="col-3">
                                                <div class="custom-control custom-checkbox my-1">
                                                    <input type="checkbox" name="permissions[]" value="{{ $per }}" class="custom-control-input su{{ $permission['ID'] }}" id="{{ $per }}">
