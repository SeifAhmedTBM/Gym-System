                ...
                <table class=" table table-bordered table-striped table-hover datatable datatable-Branch">
                    <thead>
                        <tr>
                            ...
                            <th>
                                {{ trans('cruds.branch.fields.member_prefix') }}
                            </th>
                            <th>
                                {{ trans('cruds.branch.fields.invoice_prefix') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach ($branches as $key => $branch)
                            <tr data-entry-id="{{ $branch->id }}">
                                ...
                                <td>
                                    {{ $branch->sales_manager->name ?? '-' }}
                                </td>
                                <td>
                                    {{ $branch->fitness_manager->name ?? '-' }}
                                </td>
                                <td>
                                    {{ ($branch->partner_percentage ?? '0') .' %' }}
                                </td>
                                <td>
                                    @can('branch_show')
